...
//If the question would be to print the levels in spiral order, then on the basis or eventh iteration, either push the level array into the ans array as it is or first reverse it and then push it
